...
<br>
<br><br><br><br><br><br>
<?php if ($_SESSION['logerr']==2){
?>
<center><h1>Musisz aktywować swoje konto. Sprawdź skrzynkę mailową!</h1></center>
<?php
}else if ($_SESSION['logerr']==3) {
?>
<center><h1>Brak użytkownika o takim loginie. Zarejestruj sie lub spróbuj ponownie</h1></center>
<?php
}else if ($_SESSION['logerr']==1) {
echo $_SESSION['logerr'];
?>
<center><h1>Błędne hasło.</h1></center>
<?php
}
?>
